...
L'obiettivo di questa sprint è di aggiungere la funzionalita' degli effetti delle carte (6, 7, e fante) e di
poter giocare una partita (Game) da inizio a fine.

## Scadenza

La scadenza della sprint è il 17/08/26.
